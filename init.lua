...
local plugins = {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Previews as you move and applies on select, for the session only. The
      -- default theme lives in `lua/custom/plugins/colorscheme.lua`.
  ...
  -- NOTE: Colorschemes live in `lua/custom/plugins/colorscheme.lua`.
  --  The active one is `lumon`, an aether.nvim variant defined in this config.
  --  To see what is installed, use `:Telescope colorscheme`.
